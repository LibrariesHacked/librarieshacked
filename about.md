...
Libraries Hacked was founded in response to the significant lack of open data about public libraries, in terms of their activity, catalogues, or even basic data such as locations. The goal has been to promote open data, including helping libraries publish their own data, and showing how library data can be used alongside with other open datasets.
